# GCR Virtual — Agentic Challenge 2026

## Event Details

- **Event**: AWS AI League — GCR Virtual (Greater China Region)
- **Date**: September 2026
...
![GCR Virtual Practice Map](map.png)
...
![GCR Virtual Finale 1 Map](finale-1-map.png)
...
![GCR Virtual Finale 2 Map](finale-2-map.png)
...
![GCR Virtual Finale 3 Map](finale-3-map.png)

---

## Results

The GCR Virtual was the first region where **no competitors were disqualified** from the finale — all three Round 1 qualifiers advanced cleanly.

### Round 1 Leaderboard (top finishers)

| Rank | Competitor | Score | Tokens | Finale |
|------|-----------|-------|--------|--------|
| 1 | circuss | 18997 | 1957 | Qualified |
| 2 | ababa | 18994 | 2010 | Qualified |
| 3 | Wood | 18989 | 2101 | Qualified |

### Finale Results (sum of the 3 finale rounds)

| Rank | Competitor | Finale 1 | Finale 2 | Finale 3 | Total |
|------|-----------|----------|----------|----------|-------|
| 🥇 1 | Wood | 2799 | 7649 | 12105 | **22553** |
| 🥈 2 | circuss | 1775 | 7494 | 12494 | **21763** |
| 🥉 3 | ababa | 2903 | 9791 | 7707 | **20401** |

**Winner: Wood (22,553)**. Despite finishing 3rd in Round 1, Wood's consistent finale performance (2nd in F1, 2nd in F2, close 2nd in F3) outpaced the field. ababa led after Finale 2 (the strongest single-round performance at 9,791) but a low Finale 3 dropped them to 3rd overall. circuss, the Round 1 leader, took the highest individual round score in Finale 3 (12,494) but a weak Finale 1 cost them the title.
