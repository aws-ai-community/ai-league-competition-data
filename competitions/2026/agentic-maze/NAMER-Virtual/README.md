# NAMER Virtual — Agentic Challenge 2026

## Event Details

- **Event**: AWS AI League — NAMER Virtual (North America)
- **Date**: September 2026
...
![NAMER Virtual Practice Map](map.png)
...
![NAMER Virtual Finale 1 Map](finale-1-map.png)
...
![NAMER Virtual Finale 2 Map](finale-2-map.png)
...
![NAMER Virtual Finale 3 Map](finale-3-map.png)
...
|------|-----------|-------|--------|--------|
| 1 | rosscomp1 | 19050 | 956 | Bowed out (see below) |
| 2 | Ujwal Suresh Vanjare | 19047 | 1011 | Qualified |
| 3 | amitg | 19047 | 1016 | Qualified |
| 4 | Arpita Madhukar Kalburgi | 19044 | 1061 | Qualified |

**rosscomp1** topped Round 1 but had **already qualified for re:Invent via the New York City Summit**, so gracefully bowed out of the NAMER finale to give another competitor a shot at the ticket. The finale field was filled by the next qualifiers: Ujwal Suresh Vanjare, amitg, and Arpita Madhukar Kalburgi.

### A note on token counts

The very low Round 1 token counts in NAMER (sub-1,100, with the leader under 1,000) drew some discussion. In the earlier EMEA and APJ events, several extremely low-token runs were **disqualified** as not being in the spirit of the competition (agents that recite hardcoded answers/paths rather than genuinely solving each challenge). The NAMER event applied a different interpretation, and these runs were allowed to stand.

The trade-off showed up in the finale: minimising tokens often means minimising the agent's reasoning, and some competitors' pathfinders were then **unable to find optimal routes** around the unfamiliar finale mazes — scoring low as a result. An agent tuned purely for token economy on the known Round 1 map does not necessarily generalise to the unseen finale maps, where genuine pathfinding matters.

### Finale Results (sum of the 3 finale rounds)

| Rank | Competitor | Finale 1 | Finale 2 | Finale 3 | Total |
|------|-----------|----------|----------|----------|-------|
| 🥇 1 | amitg | 1274 | 8578 | 17822 | **27674** |
| 🥈 2 | Arpita Madhukar Kalburgi | 3406 | 7326 | 7764 | **18496** |
| 🥉 3 | Ujwal Suresh Vanjare | 3708 | 4695 | 7766 | **16169** |

**Winner: amitg (27,674)**. amitg had the weakest Finale 1 of the three (1,274) but a strong Finale 2 and a dominant Finale 3 (17,822 — the highest single-round score of the finale) carried the title comfortably. Arpita and Ujwal were close after the first two rounds, but neither matched amitg's Finale 3 on the long comb maze — the round where finding an optimal route through unfamiliar territory mattered most.
